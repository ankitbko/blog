...
When you deploy an agent with `azd deploy`, it automatically assigns the `Azure AI User` role at the Foundry account scope — this is what lets your agent call Foundry models. For any other resources (storage, databases, etc.), you need to assign RBAC roles manually.
